...
async function startArus() {
    ...
    let mauriz = await arus.sendContact(callerId, global.owner)
    arus.sendMessage(callerId, { text: `Bloqueio automático do sistema!\nNão ligue para o bot!\nEntre em contato com o proprietário para ser desbloqueado!`}, { quoted : mauriz })
    await sleep(8000)
